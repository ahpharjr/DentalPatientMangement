...
const PERMANENT_TOOTH_NAMES = {
    ...
    9: "Central Incisor", 10: "Lateral Incisor", 11: "Canine",
    12: "1st Premolar", 13: "2nd Premolar", 14: "1st Molar",
    15: "2nd Molar", 16: "3rd Molar",

    17: "3rd Molar", 18: "2nd Molar", 19: "1st Molar",
    20: "2nd Premolar", 21: "1st Premolar", 22: "Canine",
    23: "Lateral Incisor", 24: "Central Incisor",

    25: "Central Incisor", 26: "Lateral Incisor", 27: "Canine",
    28: "1st Premolar", 29: "2nd Premolar", 30: "1st Molar",
    31: "2nd Molar", 32: "3rd Molar",
};
...
const CONDITION_STYLES = {
    ...
    bridge: "border-amber-500 bg-amber-500/10 text-amber-400",
    implant: "border-cyan-500 bg-cyan-500/10 text-cyan-400",
    veneer: "border-pink-500 bg-pink-500/10 text-pink-400",
    dentures: "border-indigo-500 bg-indigo-500/10 text-indigo-400",
...
const CONDITION_META = {
    ...
    caries: { label: "Caries", color: "red" },
    filled: { label: "Filled", color: "blue" },
    crown: { label: "Crown", color: "yellow" },
    root_canal: { label: "Root Canal", color: "purple" },
    bridge: { label: "Bridge", color: "amber" },
    implant: { label: "Implant", color: "cyan" },
    veneer: { label: "Veneer", color: "pink" },
    dentures: { label: "Dentures", color: "indigo" },
    missing: { label: "Missing / Extracted", color: "gray" },
    problem: { label: "Problem", color: "orange" },
};
...
export default function PermanentTeethChart() {
        ...
        return (
            <div
                ...
                className={`flex h-11 w-11 cursor-pointer items-center justify-center
                  ...
                  transition hover:ring hover:ring-white/30
                  ${style}`}
            >
                {label}
            </div>
    ...
    const summary = ALL_TEETH.reduce(
        (acc, tooth) => {
    ...
    const SUMMARY_META = {
        ...
        caries: { label: "Caries", color: "text-red-500" },
        filled: { label: "Filled", color: "text-blue-500" },
        crown: { label: "Crown", color: "text-yellow-500" },
        root_canal: { label: "Root Canal", color: "text-purple-500" },
        bridge: { label: "Bridge", color: "text-amber-500" },
        implant: { label: "Implant", color: "text-cyan-500" },
        veneer: { label: "Veneer", color: "text-pink-500" },
        dentures: { label: "Dentures", color: "text-indigo-500" },
        missing: { label: "Missing / Extracted", color: "text-zinc-400" },
        problem: { label: "Problem", color: "text-orange-500" },
    };
            ...
            <div className="rounded-xl border border-white/10 bg-zinc-900 p-5">
                ...
                <div className="mb-4 flex items-start gap-2">
                    ...
                    <div>
                        <h3 className="text-sm font-medium text-white">
                            Odontogram (Permanent Teeth)
                        </h3>
                        <p className="text-xs text-zinc-400">
                            Interactive dental chart for permanent teeth using Universal
                            Numbering System (1–32). Click on any tooth to view or add marking
                            records.
                        </p>
                    </div>
                </div>
                ...
                <div className="mb-6 flex flex-wrap gap-4 text-xs">
                    {Object.entries(CONDITION_META).map(([key, meta]) => (
                        <Legend key={key} color={meta.color} label={meta.label} />
                    ))}
                </div>
...
const legendColors = {
    ...
    amber: "border-amber-500 bg-amber-500/20",
                ...
                <div className="mb-4 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        <h3 className="text-sm font-semibold">
                            Tooth {tooth} – {PERMANENT_TOOTH_NAMES[tooth]}
                        </h3>
    ...
    return (
        ...
        >
            ...
            >
                ...
                <div className="mb-4 flex items-center justify-between">
                    <h3 className="text-sm font-semibold">
                        Add Marking Record – Tooth {tooth} ({PERMANENT_TOOTH_NAMES[tooth]})
                    </h3>
