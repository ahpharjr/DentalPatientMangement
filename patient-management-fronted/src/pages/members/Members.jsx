      ...
      <PageHeader
        ...
        action={
          <button
            ...
            className="flex items-center gap-2 rounded-xl bg-blue-600 px-5 py-2 text-sm font-medium text-white shadow-lg hover:bg-blue-500 transition"
          >
        ...
        <table className="w-full text-sm">
          ...
          <thead className="bg-zinc-900 text-zinc-400">
            <tr>
              ...
              <th className="px-6 py-4 text-left font-medium">Clinic</th>
          ...
          <tbody>
            {members.map((m) => (
              ...
              >
                ...
                <td className="px-6 py-5">
                  <span
                    className={`rounded-full px-5 py-2 text-xs font-medium ${getRoleBadge(
                      m.role
                    )}`}
                  >
                    {m.role}
